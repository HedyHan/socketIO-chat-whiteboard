...
class Draw {
    ...
    bindEvents() {
        let self = this;
        this._whiteboard.addEventListener('mousedown', function (e) {
            self.onMousedown(e);
        });
        this._whiteboard.addEventListener('mouseup', function (e) {
            self.onMouseup(e);
        });
        this._whiteboard.addEventListener('mouseout', function (e) {
            self.onMouseout(e);
        });
        this._whiteboard.addEventListener('mousemove', function (e) {
            self.onMousemove(e);
        });
    }
    ...
    bindSocketEvents() {
        ...
        socket.on('draw_remote', function (data) {
            let coords = {
